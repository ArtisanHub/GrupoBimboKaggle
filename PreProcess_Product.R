...
product_data <- read.csv('/home/prashan/Desktop/DM/Kaggle/data/producto_tabla.csv')
preprocessed <- preprocess_products(product_data)
write.csv(preprocessed, '/home/prashan/Desktop/DM/Kaggle/data/processed_data/preprocessed_products.csv')